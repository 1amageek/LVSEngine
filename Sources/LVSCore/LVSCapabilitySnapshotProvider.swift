    ...
    public func snapshot() -> LVSCapabilitySnapshot {
        LVSCapabilitySnapshot(
            ...
            agentContracts: [
                ...
                "Netgen LVS device and pin-policy declarations can be imported into an auditable seed through NetgenLVSDeviceDeckImporter and lvsengine --import-netgen-devices --netgen-setup <path>, with concrete $dev foreach expansion, lvs-device-policy-seed, lvs-foundry-device-import-report artifacts, compact seedSummary stdout, and lvs-device-import-audit verification through lvsengine --audit-netgen-device-import; installed foundry PDK import is exposed through lvsengine --import-foundry-netgen-devices, while lvsengine --import-sky130-netgen-devices remains only as a deprecated compatibility route through signoff profile discovery and semantic readiness.",
